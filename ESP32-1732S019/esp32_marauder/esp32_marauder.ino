...
void setup()
{
  ...
  */
  ...
  #ifdef HAS_SCREEN
    display_obj.tft.drawCentreString("ESP32 Marauder", 160, 40, 1);
    display_obj.tft.drawCentreString("JustCallMeKoko", 160, 70, 1);
    display_obj.tft.drawCentreString(display_obj.version_number, 160, 100, 1);
  #endif
  ...
  buffer_obj = Buffer();
    ...
    display_obj.tft.drawCentreString("Initializing...", 160, 130, 1);
  #endif
